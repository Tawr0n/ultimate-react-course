        ...
        <div style={containerStyle} className={className}>
            <div style={starContainerStyle}>
                {Array.from({length: maxRating}, (_, i) => (
                    <Star isFull={tempRating ? tempRating > i : rating > i} key={i}
...
const Star = ({
    ...
    return (
        <span onMouseEnter={onHoverIn} onMouseLeave={onHoverOut} onClick={onSetRating} style={starStyle} role='button'>
          {isFull
